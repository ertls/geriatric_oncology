...
möglich. Bei den restlichen 15 Patiente (3\%) handelt es sich um
...
erreicht, maximal \tugMax{}~ Sekunden. Die mediane Zeit zur
Bewältigung des Tests bei den Patienten, die teilnehmen konnten, lag
bei \medianTug{}~Sekunden. Nach Beurteilung des TUG besteht bei 38\% der
untersuchten Patienten eine eingeschränkte Mobilität, die jedoch noch
zu keiner Einschränkung im Alter führt ($10s \leq TUG \leq 19s$). Bei 15\%
der Patienten muss von einer Beeinträchtigung in den Aktivitäten des
täglichen Lebens ausgegangen werden ($TUG \geq 20s$). 47\% der Patienten
haben laut Beurteilung des TUG eine normale Mobilität ($TUG <
10s$). Bei den verbleibenden 2\% der Patienten wurde der TUG nicht
durchgeführt.

\subsection{Mini-Mental-Status-Test}
Der MMST wurde bei \nMmst{} Patienten (\percentMmst{}\%)
durchgeführt. Nach der aktueller deutscher S3-Leitlinie Demenz
...
\gdsMin{}. Nach Einteilung des GDS ist ein Wert bis 5 normal
einzuschätzen, zwichen 6 und 9 besteht der Verdacht auf eine
Depression und eine weitere Diagnostik sollte angestrebt werden, ab
einem Wert von 10 besteht fast immer auch eine Depression. Nach dieser
...
ein Wert von 10 bestimmt. In der Beurteilung des Tests ist ein Wert bis 2
...
Tabelle~\ref{tab:charlson} den Anteil der Patienten.
...
beschreibenden Text die kategorielle Variable Alleinlebend erstellt,
...
die Ergebnisse des Barthel-Index, der IADL-Skala, des MNA, der MMST
und des DemTect-Tests, des Komorbiditätsindex und des Tinetti-Tests
benutzt, um die Anzahl der Defizite zu berechnen. Dabei wurde anders
als in der angegebenen Publikation jedes aufällige Testergebniss als
Defizit definiert, also Barthel-Index kleiner 100, IADL-Wert kleiner
7, MNA kleiner 24, MMST kleiner 27 oder DemTect kleiner 13,
Charlson-Index größer 0 und Tinetti-Test kleiner 25. Bei 297 Patienten
liegen alle benötigten Werte vor (71\%), der Median liegt bei 2
...
In der Publikation von Wedding wird die Komorbidität nicht
berücksichtigt, außerdem wird erst ein MMST kleiner 24 als Defizit
definiert. Aus Vergleichsgründen wurde diese Definition auch auf die
vorliegende Population angewendet. Bei 308 Patienten
liegen alle benötigten Werte vor (73\%), der Median liegt ebenfalls
bei 2 Defiziten, Die Häufigkeitsverteilung ist in
Tabelle~\ref{tab:defiziteWedding} gezeigt. Die Unterschiede werden in
Abschnitt~\ref{sec:defizite_discussion} diskutiert.
...
die relativen Häufigkeiten der einzelnen Kategorien der verschiedenen
Einschätzungsmöglichkeiten dar. In den
