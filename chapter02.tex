...
1 zu 1 ($1:1=1$) Chance. Allgemein gelten
Gleichung~\ref{eq:odds1} und \ref{eq:odds2}. Im weiteren Text wird für Chance das
...
Ereignis $A$ eintritt. In Gleichung~\ref{eq:logit} zeigt sich, dass
das Verhältnis der logarithmierten Odds bezüglich der unabhängigen
...
\begin{equation}
\label{eq:logit2}
\ln\bigg(\frac{p_i(X)}{1 - p_i(X)}\bigg) = \beta_0 + \beta_1
X_{1,i} + \dots + \beta_m X_{m,i}
\end{equation}
